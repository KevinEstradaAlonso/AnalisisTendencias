      ...
      <div
        className={
          [
            ...
            // fills usados por AreaChart de sentimiento
            'fill-rose-500 fill-emerald-500 fill-gray-500',
            'dark:fill-rose-500 dark:fill-emerald-500 dark:fill-gray-500',
            ...
            'bg-rose-500 bg-emerald-500 bg-gray-500',
            'dark:bg-rose-500 dark:bg-emerald-500 dark:bg-gray-500',
            'text-blue-500 text-teal-500 text-purple-500 text-pink-500 text-red-500 text-orange-500 text-yellow-500 text-green-500',
            'text-rose-500 text-emerald-500 text-gray-500',
            'dark:text-rose-500 dark:text-emerald-500 dark:text-gray-500',
            ...
            // stroke para charts adicionales
            'stroke-rose-500 stroke-emerald-500 stroke-gray-500',
            'dark:stroke-rose-500 dark:stroke-emerald-500 dark:stroke-gray-500',
